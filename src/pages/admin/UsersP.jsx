...
const UsersPage = () => {
  ...
  const onFinish = async (values) => {
    try {
      const { first_name, last_name, username, phoneNumber, birthday, address, email, description, password } = values;
      const postData = {
        first_name,
        last_name,
        username,
              ...
              dataSource.map((res) => (
                <tr key={res._id} className="responsive-table__row">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <span style={{ color: "red" }}>{res.last_name}</span>
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="responsive-table__body__text  responsive-table__body__text--update">
                    {res.email == null ? " err Email! " : res?.email}
                  </td>
